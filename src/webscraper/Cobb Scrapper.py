    ...
    for k in the_cols:
        ...
        if k=='booking_timestamp':
            try:
                ...
                inmate_row_i[k]=date_book.split(" ")[0].split("/")[2]+'-'+date_book.split(" ")[0].split("/")[0]+'-'+date_book.split(" ")[0].split("/")[1]+' '+date_book.split(" ")[1]+' EST'
            except Exception as e:
                inmate_row_i['notes']+=' Error with column '+k+': '+str(e)+' | '
...
with open(r'C:\Users\Desktop\Cobb County\Cobb_'+stamp+'-'+full_time+'.csv', 'w') as csvfile:
